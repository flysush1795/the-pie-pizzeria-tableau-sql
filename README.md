...
4. **Percentage of sales by Pizza Size: Created a custom chart that represents the percentage of sales attributed to different pizza sizes. This chart helped us understand customer preferences for pizza sizes and their impact on sales.**
...
5. **Best Sellers (Top-5): Created bar chart to identify top 5 best sellers by revenue, total quantity and total orders.**
...
- **Hourly Trend Analysis**: The highest number of orders recieved in a day was from 12 PM to 1 PM which can be attributed to the rush hours and hence the resoures need to be managed accordingly.
-  **Sales by Pizza Category & Size**: Pizza sales are fairly consistent across categories, but by size, large pizzas are the most ordered, contributing nearly 46% of total sales.
-  **Average Sales**: The average number of pizzas sold per day over a week is 402.
- **Bottom 5 Pizza by Revenue:** Identified the lowest-performing pizza by revenue and recommended incorporating customer feedback to improve recipes accordingly.
